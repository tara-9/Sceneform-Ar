...
public class MainActivity extends AppCompatActivity implements
    ...
    private boolean percyDictated = false;
...
//        database.addImage("rabbit", rabbitImage);
    ...
    public void onAugmentedImageTrackingUpdate(AugmentedImage augmentedImage) {
        Log.d(TAG, "/n/n/n Inside Image Tracking/n/n/n");
...
//                                }));
    ...
    private void loadImageDb(Session session) {

        try (InputStream inputStream = this.getAssets().open("percy.imgdb")) {
